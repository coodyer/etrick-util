...
public class MethodUtil {
    ...
    private static List<String> getConstructorParamNames(InputStream ins, Constructor<?> constructor) {
    ...
    public static List<String> getParamNames(InputStream in, EnclosingMetadata m) throws IOException {
...
//              System.out.println("desc->"+method.desc+":"+m.desc);
    ...
    public static void main(String[] args) throws IOException {
        for (Method m : MethodUtil.class.getDeclaredMethods()) {
            List<String> list = getMethodParamNames(MethodUtil.class, m);

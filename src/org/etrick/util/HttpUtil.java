...
public class HttpUtil {
	...
	//private final static BaseLogger logger = BaseLogger.getLogger(HttpUtil.class);
	...
	public static HttpEntity Get(String url, Integer timeout,
			String sendCookie, Map<String, String> headers,Proxy proxy) {
		try {
	...
	public static HttpEntity Get(String url, String encode, String sendCookie,
			Integer timeout, Map<String, String> headers,Proxy proxy) {
		try {
			return httpBaseConn(url, GET, null, encode, timeout, sendCookie,
					headers,proxy);
		} catch (Exception e) {
	...
	public static HttpEntity Post(String url, String postData, Integer timeout,
			String sendCookie,Proxy proxy) {
		try {
			return httpBaseConn(url, POST, postData, null, timeout, sendCookie,
					null,proxy);
		} catch (Exception e) {
	...
	public static HttpEntity Post(String url, String postData, String encode,
			String sendCookie,Proxy proxy) {
		try {
			return httpBaseConn(url, POST, postData, encode, null, sendCookie,
					null,proxy);
		} catch (Exception e) {
	...
	public static HttpEntity Post(String url, String postData, String encode,
			Integer timeout, String sendCookie,Proxy proxy) {
		try {
			return httpBaseConn(url, POST, postData, encode, timeout,
					sendCookie, null,proxy);
		} catch (Exception e) {
	...
	public static HttpEntity Post(String url, String postData, String encode,
			Integer timeout, String sendCookie, Map<String, String> headers,Proxy proxy) {
		try {
			return httpBaseConn(url, POST, postData, encode, timeout,
					sendCookie, headers,proxy);
		} catch (Exception e) {
